...
def index():
    ...
    genres = df.iloc[:, 4:]
    totals = genres.sum(axis=0)
    sorted_vals = totals.sort_values(ascending=False)
    top_three_genres = sorted_vals.index[0:3].tolist()
    top_three_values = sorted_vals.values[0:3].tolist()
